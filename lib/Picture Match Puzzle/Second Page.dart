...
class _SecondPageState extends State<SecondPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Select Level"),backgroundColor: Colors.teal,
      ),
      body: Column(
        children: [
          Expanded(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return InkWell(
                            ...
                            child: Container(margin: EdgeInsets.all(5),
                              height: 60,width: 100,color: (index <=cur_level) ? Colors.teal : Colors.teal.shade100, alignment: Alignment.center,
                              child: (index <cur_level+1) ? Text("Level ${level[index]} - ${second[index]}s",style: TextStyle(fontSize: 22,color: Colors.white)) :
